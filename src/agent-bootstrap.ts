...
OCR (v1.7 — read text where there is no ui tree):
  ...
  live_preview true            → (optional) push frames to /monitor; since v4.8 the monitor page auto-streams by itself while the human has it open, so you normally never need this
