...
cd "$(dirname "$0")/.."
suites=("$@"); [[ ${#suites[@]} -eq 0 ]] && suites=(e2e.sh e2e-v15.sh e2e-v16.sh e2e-v17.sh e2e-v18.sh e2e-v19.sh e2e-v20.sh e2e-v21.sh e2e-v22.sh e2e-v23.sh e2e-v24.sh e2e-v25.sh e2e-v26.sh e2e-v27.sh e2e-v28.sh e2e-v29.sh e2e-v30.sh)
